...
#define FND4_CLK_PORT GPIOC
#define FND4_CLK_PIN GPIO_PIN_10
#define FND4_DIO_PORT GPIOC
#define FND4_DIO_PIN GPIO_PIN_12
...
{
	TM1637_DisplayNumber(&display, num);
}
...
{
	TM1637_Init(&display,
			FND4_CLK_PORT, FND4_CLK_PIN,
			FND4_DIO_PORT, FND4_DIO_PIN);
	TM1637_SetBrightness(&display, Brightness0);
}
